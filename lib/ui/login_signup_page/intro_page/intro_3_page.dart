...
class Intro_3_page extends StatelessWidget {
  const Intro_3_page({super.key, required this.back, required this.next});
  final Function() back;
  final Function() next;
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: 4),
                      child: Text(tr('login.b3'), style: AppTextStyle.type20.copyWith(color: AppColor.white)),
                    ),
                  )),
                ],
              ),
